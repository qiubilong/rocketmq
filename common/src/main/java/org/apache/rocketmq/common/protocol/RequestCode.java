...
public class RequestCode {
    ...
    public static final int END_TRANSACTION = 37; /* 半事务消息 - 确认 */
    public static final int GET_CONSUMER_LIST_BY_GROUP = 38;

    public static final int CHECK_TRANSACTION_STATE = 39; /* 半事务消息回查 */
    ...
    public static final int SEND_MESSAGE_V2 = 310;                  /* 存储消息 */

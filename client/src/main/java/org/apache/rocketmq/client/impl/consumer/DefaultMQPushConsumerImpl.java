...
public class DefaultMQPushConsumerImpl implements MQConsumerInner {
    ...
    public void pullMessage(final PullRequest pullRequest) {
        ...
        if (!this.consumeOrderly) { /* 流控处理- 消息偏移堆积超过2000 */
        ...
        PullCallback pullCallback = new PullCallback() {
            ...
            public void onException(Throwable e) {
                ...
                if (e instanceof MQBrokerException && ((MQBrokerException) e).getResponseCode() == ResponseCode.FLOW_CONTROL) {
                    ...
                    DefaultMQPushConsumerImpl.this.executePullRequestLater(pullRequest, pullTimeDelayMillsWhenException);//3s
                }
            }
        };
        /* ## 指定最新 消费偏移offset */
        ...
        try {    /* ## 异步拉取消息 */
            this.pullAPIWrapper.pullKernelImpl(
                ...
                BROKER_SUSPEND_MAX_TIME_MILLIS,   /* 无消息时，允许挂起15s - 服务端主动推送 */
    ...
    private void executePullRequestLater(final PullRequest pullRequest, final long timeDelay) {
        this.mQClientFactory.getPullMessageService().executePullRequestLater(pullRequest, timeDelay);/* 添加拉取消息请求通知 */
    }
    ...
    public synchronized void start() throws MQClientException {
        switch (this.serviceState) {
            case CREATE_JUST:
                ...
                this.rebalanceImpl.setMessageModel(this.defaultMQPushConsumer.getMessageModel());//默认消费组模式
